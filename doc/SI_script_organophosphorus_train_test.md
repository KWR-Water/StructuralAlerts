...
spectra with an organophosphorus structural alert.
...
# combine both data sets (spectra with alert, and random subset of spectra without the alert)
...
if(data.type == "neutrallosses"){
  data <- readRDS(file = "data\\NIST_organophosphorus_neutrallosses_pos_largerbinsize_hrms.RDS")
} else if (data.type == "fragments") {
  data <- readRDS(file = "data\\NIST_organophosphorus_fragments_pos_largerbinsize_hrms.RDS")
}
